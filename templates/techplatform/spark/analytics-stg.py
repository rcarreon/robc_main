...
def main(argv):
  ...
  conf = SparkConf().setAppName("OG STG analytics")
  ...
  #For STG we're procesing data from 2016
  select_origin = sqlContext.read.json("hdfs://{0}/flume/origin/stg/2016/*/*".format(hdfs))
