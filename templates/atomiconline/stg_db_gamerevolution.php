<?php
  ...
  $config['dbhost'] = 'vip-sqlrw-gr.ao.stg.lax.gnmedia.net';
  $config['dbuname'] = 'gamrev_rw';
  $config['dbname'] = 'gamerevolution';
  $config['dbpass'] = '<%= grstgdbpass %>';
  $config['maildbname'] = "gr_mail";
  $config['maildbconn'] = 0;

  $config['doc_root_dir'] = '/app/shared/docroots/stg.gamerevolution.com/htdocs/';
