...
db = create_engine('mysql://vipvisual:'+sqlpassword+'@'+sqlhostname+':3306/servers?\
...
hostname=%s&frm=%s&until=%s">[ggp 24hr]</a>' % \
    ...
    gweb_hour = '<a href="http://gweb.gnmedia.net/?h=%s&r=hour&metric_group=NOGROUPS&z=small">[gweb 1hr]</a>' % (hostname)
    gweb_4hour = '<a href="http://gweb.gnmedia.net/?h=%s&r=4hr&metric_group=NOGROUPS&z=small">[gweb 4hr]</a>' % (hostname)
    gweb_day = '<a href="http://gweb.gnmedia.net/?h=%s&r=day&metric_group=NOGROUPS&z=small">[gweb day]</a>' % (hostname)
    gweb_week = '<a href="http://gweb.gnmedia.net/?h=%s&r=week&metric_group=NOGROUPS&z=small">[gweb week]</a>' % (hostname)
    return real_text + hr_text + eight_hr_text + day_text + " " + gweb_hour + gweb_4hour + gweb_day + gweb_week
