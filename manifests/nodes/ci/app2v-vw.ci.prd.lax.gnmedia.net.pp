node 'app2v-vw.ci.prd.lax.gnmedia.net' {
    include newrelic
    ...
    common::nfsmount { '/app/log':
        device  => 'nfsB-netapp1.gnmedia.net:/vol/nac1b_ci_lax_prd_app_log/app2v-vw.ci.prd.lax.gnmedia.net',
    }

    common::nfsmount { '/app/data':
        device  => 'nfsB-netapp1.gnmedia.net:/vol/nac1b_ci_lax_prd_app_data/app2v-vw.ci.prd.lax.gnmedia.net',
    }

    common::nfsmount { '/app/data/vwmodels':
        device  => 'nfsB-netapp1.gnmedia.net:/vol/nac1b_ci_lax_prd_app_vwmodels/app2v-vw.ci.prd.lax.gnmedia.net',
    }
