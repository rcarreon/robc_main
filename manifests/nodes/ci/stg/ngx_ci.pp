class crowdignite::ngx_ci_stg {
    ...
    ### STG vhost declaration
    $env='stg'
    nginx::vhost {'stg.widget.crowdignite.com': virtual_template=>'widget.crowdignite.com',vhost_list=>'stg.widget.crowdignite.com stg.widget.raaze.com'}

    nagios::service {'widgets_17_xml':
        command => "check_url_xml!stg.widget.crowdignite.com!http://${::fqdn}/widgets/17?content=xml!10!",
        notes_url => "http://docs.gnmedia.net/wiki/Nagios-check_url",
    }

    nagios::service {'widgets_36_xml2':
        command => "check_url_xml!stg.widget.crowdignite.com!http://${::fqdn}/widgets/36?content=xml2!10!",
        notes_url => "http://docs.gnmedia.net/wiki/Nagios-check_url",
    }

    nagios::service {'widgets_36_xml_live':
        command => "check_url_xml!stg.widget.crowdignite.com!http://${::fqdn}/widgets/36?content=xml_live!10!",
        notes_url => "http://docs.gnmedia.net/wiki/Nagios-check_url",
    }
