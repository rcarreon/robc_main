node 'eng6v-ci.ci.prd.lax.gnmedia.net' {
    include newrelic
    ...
    include cronjob
    cronjob::do_cron_dot_d_cron_file {'eng6.cron': }
    ...
    common::nfsmount { '/app/log':
        device  => 'nfsB-netapp1.gnmedia.net:/vol/nac1b_ci_lax_prd_app_log/eng6v-ci.ci.prd.lax.gnmedia.net',
    }
    ...
    file { '/app/log/cronjobs/jobspec/eng6.cron':
        owner   => root,
        group   => root,
        mode    => '0644',
        source  => 'puppet:///modules/cronjob/cron.d/crowdignite_engine/eng6.cron',
    }
