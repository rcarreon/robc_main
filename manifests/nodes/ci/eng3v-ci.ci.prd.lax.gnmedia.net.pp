node 'eng3v-ci.ci.prd.lax.gnmedia.net' {
    include newrelic
    ...
    include cronjob
    cronjob::do_cron_dot_d_cron_file {'eng3.cron': }
    ...
    common::nfsmount { '/app/log':
        device  => 'nfsA-netapp1.gnmedia.net:/vol/nac1a_ci_lax_prd_app_log/eng3v-ci.ci.prd.lax.gnmedia.net',
    }
    ...
    file { '/app/log/cronjobs/jobspec/eng3.cron':
        owner   => root,
        group   => root,
        mode    => '0644',
        source  => 'puppet:///modules/cronjob/cron.d/crowdignite_engine/eng3.cron',
    }
