node 'app1v-build.ap.dev.lax.gnmedia.net' {
  include base
  $project='adops'
  include common::app
  ...
  common::nfsmount { "/app/log":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_ap_lax_dev_app_log/app1v-build.ap.dev.lax.gnmedia.net",
  }
  ...
  common::nfsmount { "/app/go-agent":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_ap_lax_dev_go_agents/app1v-build.ap.dev.lax.gnmedia.net"
  }
