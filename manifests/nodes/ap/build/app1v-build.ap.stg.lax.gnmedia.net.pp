node 'app1v-build.ap.stg.lax.gnmedia.net' {
  include base
  $project = 'adops'
  include adops::build
  include git::client
  ...
  common::nfsmount { '/app/shared':
    device => 'nfsA-netapp1.gnmedia.net:/vol/nac1a_ap_lax_stg_app_shared/build-shared',
  }
  ...
  common::nfsmount { '/app/log':
    device => 'nfsA-netapp1.gnmedia.net:/vol/nac1b_ap_lax_stg_app_log/app1v-build.ap.stg.lax.gnmedia.net',
  }

  common::nfsmount { "/app/go-agent":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_ap_lax_stg_go_agents/app1v-build.ap.stg.lax.gnmedia.net"
  }
