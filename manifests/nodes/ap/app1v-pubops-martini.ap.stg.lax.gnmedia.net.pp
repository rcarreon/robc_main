node 'app1v-pubops-martini.ap.stg.lax.gnmedia.net' {
  include base
  $project='adops'
  ...
  common::nfsmount { '/app/log':
    device  => 'nfsB-netapp1.gnmedia.net:/vol/nac1b_ap_lax_stg_app_log/app1v-pubops-martini.ap.stg.lax.gnmedia.net',
  }
