node 'app1v-55-dh.si.prd.lax.gnmedia.net' {
    include base
    $project="doublehelix"
    include common::app
    include yum::ius
 ...
 # NEED DB CONF FILE
    ...
    common::nfsmount { "/app/log":
        device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_si_lax_prd_app_log/app1v-55-dh.si.prd.lax.gnmedia.net",
    }
    common::nfsmount { "/app/tmp":
        device  => "nfsB-netapp1.gnmedia.net:/vol/nac1b_si_lax_prd_app_tmp/app1v-55-dh.si.prd.lax.gnmedia.net",
    }
