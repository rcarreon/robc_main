node 'app1v-55-dh.si.dev.lax.gnmedia.net' {
    include base
    $project="doublehelix"
    include common::app
    include yum::ius
   ...
   file { '/app/shared/docroots/':
    ...
    common::nfsmount { "/app/log":
        device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_si_lax_dev_app_log/app1v-55-dh.si.dev.lax.gnmedia.net",
    }
    common::nfsmount { "/app/tmp":
        device  => "nfsB-netapp1.gnmedia.net:/vol/nac1b_si_lax_dev_app_tmp/app1v-55-dh.si.dev.lax.gnmedia.net",
    }
