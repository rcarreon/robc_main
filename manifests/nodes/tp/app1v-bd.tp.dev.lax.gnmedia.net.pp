node 'app1v-bd.tp.dev.lax.gnmedia.net' {
  include newrelic
  ...
  common::nfsmount { "/app/log":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_tp_lax_dev_app_log/app1v-bd.tp.dev.lax.gnmedia.net",
  }

  common::nfsmount { "/app/data":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_tp_lax_dev_app_data/app1v-bd.tp.dev.lax.gnmedia.net",
  }
