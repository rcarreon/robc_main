node 'app6v-hadoop-bd.tp.prd.lax.gnmedia.net' {
  include base
  include newrelic
  ...
  common::nfsmount { '/app/data':
    device  => 'nfsA-netapp1.gnmedia.net:/vol/nac1a_tp_lax_prd_app_data/hadoop6',
  }

  common::nfsmount { '/app/log':
    device  => 'nfsA-netapp1.gnmedia.net:/vol/nac1a_tp_lax_prd_app_log/app6v-hadoop-bd.tp.prd.lax.gnmedia.net',
  }
