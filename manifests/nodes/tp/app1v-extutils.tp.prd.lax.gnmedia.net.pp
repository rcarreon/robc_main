node 'app1v-extutils.tp.prd.lax.gnmedia.net' {
    include newrelic
	...
	httpd::virtual_host {"standup.gorillanation.com":monitor => "false",}
        ...
        common::nfsmount { "/app/shared":
                device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_tp_lax_prd_app_shared/extutils-shared",
        }

        common::nfsmount { "/app/log":
                device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_tp_lax_prd_app_log/app1v-extutils.tp.prd.lax.gnmedia.net",
        }
}
