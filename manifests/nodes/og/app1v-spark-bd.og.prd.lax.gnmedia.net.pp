node 'app1v-spark-bd.og.prd.lax.gnmedia.net' {
  include base
  ...
  common::nfsmount { "/app/log":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_og_lax_prd_app_log/app1v-spark-bd.og.prd.lax.gnmedia.net",
  }

  common::nfsmount { "/app/data":
    device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_og_lax_prd_app_data/app1v-spark-bd.og.prd.lax.gnmedia.net",
  }
