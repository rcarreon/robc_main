node 'app2v-be-sdc.ao.prd.lax.gnmedia.net' {
    include newrelic
...
#### Commenting out Sphinx while this box is unused
#  sphinx::conf { 'prd-sdc': span => '12', }
  ...
  common::nfsmount { '/app/log':
    device  => "nfsB-netapp1.gnmedia.net:/vol/nac1b_ao_lax_prd_app_log/app2v-be-sdc.ao.prd.lax.gnmedia.net",
  }
