...
############################################################################
    ...
    class uidpb::devserver {
        # moved to node scope because this doesn't work with dynamic scoping
        #$project="atomiconline"
        include uidpb::dev_packages
        include uidpb::sites
        include uidpb::sitesugc
        include uidpb::appdirs
        include uidpb::apc_config
        include uidpb::setupscript
...
############################################################################
    ...
    class uidpb::dev_packages {
        ...
        class {'php::install': ini_template => 'pebblebed/php.ini-sbx.erb', extra_packages => ["php-mcrypt", "php-pecl-apc", "php-pecl-xdebug", "php-mbstring", "php-tidy",]}
...
#   httpd::virtual_host  {"forums.wrestlezone.com":                   monitor => false,                      }
    ...
    httpd::pbuid_wpvhost {"momtastic.com":                            expect => "false", needextra => "true",}
    httpd::pbuid_wpvhost {"webecoist.com":                            expect => "false", needextra => "true",}
    httpd::pbuid_wpvhost {"au.momtastic.com":                         expect => "false",                     }
    httpd::pbuid_wpvhost {"ca.momtastic.com":                         expect => "false",                     }
    httpd::pbuid_wpvhost {"uk.momtastic.com":                         expect => "false",                     }
    ...
    httpd::pbuid_wpvhost {"awards.totalbeauty.com":                   expect => "false",                     }
    httpd::pbuid_wpvhost {"mandatory.com":                            expect => "false",                     }
    httpd::pbuid_wp_beta_vhost {"hockeysfuture.com":                  expect => "false", needextra => "true",}
...
#sbxtoken
        ...
        #### Create api.dfp.gnmedia.net dbcred file
        $uid_api_dfpro=decrypt("zhw94RJYw+hz8hRsbUlSfw==")
        $uid_api_dfprw=decrypt("HxLiqUuHUxQOPlNNWjLKyw==")
        file { "/app/shared/api_dfp/dbcred/db_api.dfp.gnmedia.net.php":
             content => template('atomiconline/uid_db_api.dfp.gnmedia.net.php'),
             }
