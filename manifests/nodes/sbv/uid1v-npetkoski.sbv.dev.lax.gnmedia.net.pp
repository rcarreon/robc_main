node 'uid1v-npetkoski.sbv.dev.lax.gnmedia.net' {
    include newrelic
    ...
    common::nfsmount { "/sql/data":
        device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_uid1v_npetkoski_sbv_dev_lax_data",
    }

    common::nfsmount { "/sql/binlog":
        device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_uid1v_npetkoski_sbv_dev_lax_binlog",
    }

    common::nfsmount { "/app/shared":
        device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_sbv_lax_dev_uid_shared/npetkoski-shared",
    }

    common::nfsmount { "/app/log":
        device  => "nfsA-netapp1.gnmedia.net:/vol/nac1a_sbv_lax_dev_uid_log/uid1v-npetkoski.sbv.dev.lax.gnmedia.net",
    }
