# puppet_master_27::config class
class puppet_master_27::config {

    File{
        require => Class['puppet_master_27::packages'],
    }
    ...
    file { '/etc/puppet/puppet.conf':
        ...
        content   => template('puppet_master_27/puppet.conf.erb'),
        owner     => 'root',
        group     => 'root',
        mode      => '0644',
    }
    ...
    file { '/etc/sysconfig/puppet':
        ...
        content   => template('puppet_master_27/sysconfig_puppet.erb'),
        owner     => 'root',
        group     => 'root',
        mode      => '0644',
    }
    ...
    file { '/usr/share/puppet/rack/puppetmasterd/config.ru':
        ...
        owner   => puppet,
        group   => puppet,
        content => template('puppet_master_27/config.ru.erb'),
        mode    => '0644',
    }

    file { '/etc/httpd/conf.d/puppet.conf':
        ensure  => present,
        content => template('puppet_master_27/puppet_httpd.conf.erb'),
        owner   => 'root',
        group   => 'root',
        mode    => '0644',
    }
    ...
    file { '/etc/httpd/conf.d/ssl.conf':
        ...
        content => template('puppet_master_27/ssl.conf.erb'),
        owner   => 'root',
        group   => 'root',
        mode    => '0644',
    }
    ...
    file { '/etc/puppet/tagmail.conf':
        ...
        source  => 'puppet:///modules/puppet_master_27/tagmail.conf',
        owner   => root,
        group   => root,
        mode    => '0644',
    }
    ...
    file {'/etc/puppet/fileserver.conf':
        ...
        source  => 'puppet:///modules/puppet_master_27/fileserver.conf',
        owner   => root,
        group   => root,
        mode    => '0644',
    }
    ...
    file {'/etc/puppet/autosign.conf':
        ...
        source  => 'puppet:///modules/puppet_master_27/autosign.conf',
        owner   => root,
        group   => root,
        mode    => '0644',
    }
    ...
    file {'/usr/local/bin/return_version':
        ...
        source  => 'puppet:///modules/puppet_master_27/return_version',
        owner   => root,
        group   => root,
        mode    => '0755',
    }
    ...
    file {'/usr/lib/ruby/site_ruby/1.8/puppet/reports/foreman.rb':
        ...
        source  => 'puppet:///modules/puppet_master_27/foreman.rb',
        mode    => '0755',
        owner   => 'deploy',
        group   => 'deploy',
    }
    ...
    file {'/usr/local/bin/kill_node_in_storeconfigs_db.rb':
        ...
        source  => 'puppet:///modules/puppet_master_27/kill_node_in_storeconfigs_db.rb',
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
    }
    ...
    file {'/usr/local/bin/encrypt.rb':
        ...
        source  => 'puppet:///modules/puppet_master_27/encrypt.rb',
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
    }
