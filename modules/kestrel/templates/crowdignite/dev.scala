...
new KestrelConfig {
  ...
  default.defaultJournalSize = 384.megabytes
  default.maxMemorySize = 256.megabytes
  ...
  queues = new QueueBuilder {
    ...
    defaultJournalSize = 768.megabytes
    maxJournalSize = 2.gigabyte
